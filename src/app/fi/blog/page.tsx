...
export default function BlogPageFi() {
  return (
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="text-sm text-gray-500">
                    6 kuukautta sitten • 4 min lukuaika
                  </div>
                </div>
                ...
                <Link 
                  href="/fi/blog/kenelle-lyyli-on-tehty"
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">4 kuukautta sitten • 7 min lukuaika</span>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">3 kuukautta sitten • 5 min lukuaika</span>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">2 kuukautta sitten • 6 min lukuaika</span>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">1 kuukausi sitten • 3 min lukuaika</span>
                </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">2 viikkoa sitten • 8 min lukuaika</span>
                </div>
