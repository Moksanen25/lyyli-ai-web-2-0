...
export default function PrivacyPageFi() {
  return (
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Tietojesi voidaan siirtää EU:n ulkopuolelle, mutta vain riittävien suojatoimien kanssa.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  ...
                  Katso tarkemmat tiedot <a href="/fi/cookies" className="text-primary hover:underline">evästekäytännöstämme</a>.
                </p>
              </div>
            </div>
