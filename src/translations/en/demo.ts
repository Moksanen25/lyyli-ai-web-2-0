...
export const demo = {
  ...
  generatedContent: {
    header: '🌱 **NEW SUSTAINABILITY INITIATIVE - ACTIONS START NEXT WEEK**',
    body: `Hi team,
...
• New recycling stations in every department
• Paperless documentation transition (IT will send instructions)
• Energy saving campaign - remember to power down equipment at the end of the day
...
#TogetherGreener`,
    teamReaction: '15 people reacted to this message 👍'
  }
};
