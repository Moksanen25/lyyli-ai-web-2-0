export const about = {
  ...
  timeline: {
    ...
    investor: {
      title: 'Ensimmäiset sijoittajat',
      description: 'Ensimmäiset sijoittajat, suomalainen perheyritys Expion Oy ja North Savo Growth Fund Ky liittyivät mukaan tarinaan.'
    },
    launch: {
      title: 'Lanseeraus',
