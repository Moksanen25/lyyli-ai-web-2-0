...
export const features = {
  ...
  additionalFeatures: {
    ...
    workflow: {
      ...
      description: "Automatisoi prosessisi räätälöidyillä työnkuluilla"
    },
    integration: {
  ...
  // Customer segments
  customerSegments: {
    navigation: "Selaa toimialoittain"
  },
  ...
  comparison: {
    ...
    description: "Löydä täydellinen paketti yrityksesi tarpeisiin.",
    feature: "Ominaisuus",
    cta: "Katso täysi hinnoittelu",
    custom: "Räätälöity",
