...
export const features = {
  ...
  subtitle: 'Suunniteltu virtaviivaistamaan viestintätyönkulkujasi',
  feature1: {
    title: 'Tekoälysisällön luominen',
    description: 'Luo ammattimaista sisältöä sekunneissa'
  },
  feature2: {
    title: 'Tiimien yhteistyö',
    description: 'Työskentele saumattomasti koko tiimisi kanssa'
  },
  feature3: {
    title: 'Ajoitus ja automaatio',
    description: 'Aseta ja unohda älykkäällä aikataulutuksella'
  },
  feature4: {
  ...
  hero: {
    ...
    description: 'Kattava valikoimamme tekoälyllä toimivia viestintätyökaluja auttaa sinua luomaan, hallitsemaan ja optimoimaan sisältöäsi kaikilla kanavilla.',
    primaryCta: 'Aloita',
  ...
  customerSegments: {
    ...
    segments: {
      tech: {
        ...
        description: 'Tekniset tiimit tarvitsevat tarkkuutta ja selkeyttä. Lyyli auttaa ohjelmistoyrityksiä luomaan parempaa dokumentaatiota, julkaisutietoja ja teknisiä markkinointimateriaaleja, jotka puhuttelevat suoraan kehittäjiä ja teknisiä käyttäjiä.',
      ...
      consulting: {
        title: 'Konsultointi ja asiantuntijapalvelut',
        tagline: 'Paranna asiakasviestintää',
        description: 'Konsultointiyritykset luottavat selkeään, ammattimaiseen viestintään. Lyyli auttaa luomaan vaikuttavia ehdotuksia, säännöllisiä asiakaspäivityksiä ja ammattimaisia raportteja, jotka esittelevät asiantuntemustasi ja ylläpitävät asiakkaiden luottamusta.',
