    ...
    <footer className="bg-white pt-16 pb-8">
      <div className="container-padding container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link to={language === 'fi' ? "/fi" : language === 'sv' ? "/sv" : "/"} className="inline-block mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={language === 'fi' ? "/fi/features" : language === 'sv' ? "/sv/features" : "/features"} className="text-primary/70 hover:text-primary transition-colors">
                  {t('footer.features')}
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to={language === 'fi' ? "/fi/faq" : language === 'sv' ? "/sv/faq" : "/faq"} className="text-primary/70 hover:text-primary transition-colors">
                  {t('footer.faq')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={language === 'fi' ? "/fi/privacy" : language === 'sv' ? "/sv/privacy" : "/privacy"} className="text-primary/70 hover:text-primary transition-colors">
                  {t('footer.privacy')}
                </Link>
              </li>
              <li>
                <Link to={language === 'fi' ? "/fi/cookies" : language === 'sv' ? "/sv/cookies" : "/cookies"} className="text-primary/70 hover:text-primary transition-colors">
                  {t('footer.cookies')}
                </Link>
              </li>
              <li>
