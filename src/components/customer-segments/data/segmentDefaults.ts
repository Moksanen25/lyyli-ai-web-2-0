...
/**
 * Default values for segment data
 */

/**
 * Default segment names when translations are not available
 */
...
/**
 * Default image URLs for segments
 */
export const defaultSegmentImages = {
