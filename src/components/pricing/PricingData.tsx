...
export const usePricingData = () => {
  ...
  const comparisonFeatures: Feature[] = [
    ...
    { name: 'conversations', free: `20${t('pricing.features.perWeek')}`, starter: `50${t('pricing.features.perWeek')}`, growth: `100${t('pricing.features.perWeek')}`, professional: t('pricing.features.unlimited'), enterprise: t('pricing.features.unlimited') },
    { name: 'posts', free: `5${t('pricing.features.perWeek')}`, starter: `10${t('pricing.features.perWeek')}`, growth: t('pricing.features.unlimited'), professional: t('pricing.features.unlimited'), enterprise: t('pricing.features.unlimited') },
    ...
    { name: 'communicationSuggestions', free: `3x${t('pricing.features.perWeek')}`, starter: `1x${t('pricing.features.perDay')}`, growth: t('pricing.features.custom'), professional: t('pricing.features.custom'), enterprise: t('pricing.features.custom') },
    { name: 'onboarding', free: '199€', starter: '199€', growth: `199€ ${t('pricing.features.freeWithAnnual')}`, professional: t('pricing.features.included'), enterprise: t('pricing.features.custom') },
