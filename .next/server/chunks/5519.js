"use strict";exports.id=5519,exports.ids=[5519],exports.modules={14866:(e,i,t)=>{t.a(e,async(e,a)=>{try{t.d(i,{C:()=>l});var n=t(20997);t(16689);var o=t(16926),s=t(27742),r=e([o,s]);[o,s]=r.then?(await r)():r;let c=(0,o.cva)("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",{variants:{variant:{default:"border-transparent bg-primary text-primary-foreground hover:bg-primary/80",secondary:"border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80",destructive:"border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",outline:"text-foreground"}},defaultVariants:{variant:"default"}});function l({className:e,variant:i,...t}){return n.jsx("div",{className:(0,s.cn)(c({variant:i}),e),...t})}a()}catch(e){a(e)}})},50947:(e,i,t)=>{t.a(e,async(e,a)=>{try{t.d(i,{Ol:()=>c,SZ:()=>m,Zb:()=>l,aY:()=>p,eW:()=>h,ll:()=>u});var n=t(20997),o=t(16689),s=t(27742),r=e([s]);s=(r.then?(await r)():r)[0];let l=o.forwardRef(({className:e,...i},t)=>n.jsx("div",{ref:t,className:(0,s.cn)("rounded-lg border bg-card text-card-foreground shadow-sm",e),...i}));l.displayName="Card";let c=o.forwardRef(({className:e,...i},t)=>n.jsx("div",{ref:t,className:(0,s.cn)("flex flex-col space-y-1.5 p-6",e),...i}));c.displayName="CardHeader";let u=o.forwardRef(({className:e,...i},t)=>n.jsx("h3",{ref:t,className:(0,s.cn)("text-2xl font-semibold leading-none tracking-tight",e),...i}));u.displayName="CardTitle";let m=o.forwardRef(({className:e,...i},t)=>n.jsx("p",{ref:t,className:(0,s.cn)("text-sm text-muted-foreground",e),...i}));m.displayName="CardDescription";let p=o.forwardRef(({className:e,...i},t)=>n.jsx("div",{ref:t,className:(0,s.cn)("p-6 pt-0",e),...i}));p.displayName="CardContent";let h=o.forwardRef(({className:e,...i},t)=>n.jsx("div",{ref:t,className:(0,s.cn)("flex items-center p-6 pt-0",e),...i}));h.displayName="CardFooter",a()}catch(e){a(e)}})},43604:(e,i,t)=>{t.a(e,async(e,a)=>{try{t.d(i,{J:()=>l});var n=t(20997),o=t(16689),s=t(27742),r=e([s]);s=(r.then?(await r)():r)[0];let l=({src:e,alt:i,fallbackSrc:t="/placeholder.svg",className:a,width:r,height:l,style:c,...u})=>{let[m,p]=(0,o.useState)(e),[h,d]=(0,o.useState)(!1),g="string"!=typeof m||m.startsWith("customerSegments.")||m.startsWith("segments.")||m.startsWith("features.")||m.includes("{{")||m.includes("}}")||!m?t:m;return n.jsx("img",{src:g,alt:i||"Image",onError:()=>{h||(console.log(`Image failed to load: ${e}, using fallback: ${t}`),p(t),d(!0))},className:(0,s.cn)("transition-opacity duration-300",h?"opacity-70":"",a),width:r,height:l,style:{objectFit:"cover",maxWidth:"100%",...c},loading:"lazy",...u})};a()}catch(e){a(e)}})},50284:(e,i,t)=>{t.d(i,{n:()=>a});let a=[{id:"10",title:"Who Lyyli Was Built For: The Invisible Burden of Communication",slug:"who-lyyli-was-built-for-invisible-burden",excerpt:"A blog about the silent responsibility of communication — and who carries it when no one is officially responsible.",content:`<p>In every organization, there's someone who carries communication — even when it's not in their job title.</p>
...
Vaan siksi, ett\xe4 se on liian t\xe4rke\xe4\xe4 j\xe4\xe4d\xe4kseen tekem\xe4tt\xe4.</p>`,featuredImage:"https://images.unsplash.com/photo-1515378791036-0648a814c963?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",publishDate:"2025-01-25",readTime:4,tags:["blog","news"],author:{name:"Mikko Oksanen",title:"Perustaja & toimitusjohtaja",image:"/lovable-uploads/39c9c229-44c8-40ee-9e43-016269635def.png"},isHighlighted:!0,language:"fi"}]},21768:(e,i,t)=>{t.d(i,{b:()=>s});var a=t(16689),n=t(92201),o=t(35548);let s=()=>{let e=(0,a.useContext)(n.A);if(void 0===e)throw Error("useSafeTranslation must be used within a LanguageProvider");let{language:i}=e,t=e=>{try{let t=e.split("."),a=o.M[i]||o.M.en;for(let i of t)if(a&&"object"==typeof a&&i in a)a=a[i];else{for(let i of(a=o.M.en,t)){if(!a||"object"!=typeof a||!(i in a))return e;a=a[i]}break}return"string"==typeof a?a:e}catch(i){return console.error("Translation error:",i),e}},s=(e,i={})=>{try{if(!e)return i.fallback||"";let a=t(e)||"";return a===e&&i.fallback&&(a=i.fallback),i.interpolation&&a&&Object.entries(i.interpolation).forEach(([e,i])=>{a=a.replace(RegExp(`{${e}}`,"g"),String(i))}),i.debug,a||i.fallback||e}catch(t){return console.error(`[safeT] Error translating key: "${e}"`,t),i.fallback||e}};return{safeT:s,blogT:(e,i={})=>s(`blog.${e}`,i),pricingT:(e,i={})=>s(`pricing.${e}`,i),heroT:(e,i={})=>s(`hero.${e}`,i),featuresT:(e,i={})=>s(`features.${e}`,i),calculatorT:(e,i={})=>s(`calculator.${e}`,i),customerSegmentsT:(e,i={})=>s(`customerSegments.${e}`,i),debugTranslation:e=>t(e),translateSegmentKey:e=>t(`customerSegments.${e}`),safeTr:(e,i={})=>s(e,i),t,language:i,isFinnish:"fi"===i}}}};